...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Encoding on Numerial features: Completed.")
            ...
            logging.info("Encoding on Categorical features: Completed.")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Opeation Data Read: Completed.")
            ...
            logging.info(
                "Applying pre-processing object on the training and testing dataframes."
            )
